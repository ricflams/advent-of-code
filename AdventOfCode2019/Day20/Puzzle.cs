...
namespace AdventOfCode2019.Day20
{
	internal static class Puzzle
	{
		...
		private static void Puzzle1()
		{
			...
			var shortestPath = ShortestPath(maze);
		...
		private static int ShortestPath(Maze maze)
		{
		...
		private static Graph BuildGraph(Maze maze)
		{
	...
	//		map[entry.LookAround().First(p => map[p] == 'A')] = '#'; // hack the 'A' away
